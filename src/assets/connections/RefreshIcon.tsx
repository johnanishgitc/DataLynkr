/**
 * Refresh/sync icon from figma_codes/Connections static/img/icons.svg.
 * 24x24 viewBox, stroke icon for header.
 */
...
const strokeWidth = 1.33276;

export function RefreshIcon({ width = 24, height = 24, color = 'white' }: RefreshIconProps) {
  return (
