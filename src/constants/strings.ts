...
export const strings = {
  ...
  enter_otp: 'Enter OTP',
  otp_placeholder: 'Enter OTP sent to your email',
  otp_sent_message: 'OTP sent to your registered email.',
  signup_prompt: 'New to DataLynkr?',
  signup: 'Sign Up',
  ...
  password_sent_by_mail_placeholder: 'Enter old password',
