...
import { View, Text, TouchableOpacity, StyleSheet, StatusBar, Alert, ActivityIndicator, BackHandler, PanResponder } from 'react-native';
...
import { defaultFromDate, defaultToDate } from '../ledger/utils/LedgerShared';
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={[styles.topBar, { paddingHorizontal: 16, paddingTop: 8, paddingBottom: 8 }]}>
        ...
        >
          <Icon name="menu" size={26} color={ICON_BG} />
        </TouchableOpacity>
        <View style={{ flex: 1 }} />
        <TouchableOpacity
...
function LeftEdgeSwipeOverlay({ onSwipeOpen }: { onSwipeOpen: () => void }) {
